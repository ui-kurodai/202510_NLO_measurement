...
class FittingAnalysisWidget(QWidget):
    ...
    def _build_ui(self):
        ...
        filter_preset_row = QHBoxLayout()
        self.filter_preset_combo = QComboBox()
        self.reload_filters_btn = QPushButton("Reload")
        self.btn_add_filter_preset = QPushButton("Add")
        self.btn_clear_filters = QPushButton("Clear")
        filter_preset_row.addWidget(self.filter_preset_combo, 1)
        filter_preset_row.addWidget(self.reload_filters_btn)
        filter_preset_row.addWidget(self.btn_add_filter_preset)
        filter_preset_row.addWidget(self.btn_clear_filters)
        ...
        f.addRow("filter preset:", filter_preset_row)
    ...
    def _connect(self):
        ...
        self.btn_add_filter_preset.clicked.connect(self._append_selected_filter_preset)
        self.btn_clear_filters.clicked.connect(self.le_filters.clear)
